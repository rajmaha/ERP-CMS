...
const HeroIconPicker = ({ value, onChange, label }) => {
  ...
  return (
    <div className="hero-icon-picker-container">
      {label && <label className="hero-icon-picker-label">{label}</label>}
      
      <div className="hero-icon-picker-input" onClick={() => setShowPicker(!showPicker)}>
        {value ? (
      ...
      {showPicker && (
        <>
          <div className="hero-icon-picker-overlay" onClick={() => setShowPicker(false)}></div>
          <div className="hero-icon-picker-dropdown-large">
            <div className="hero-icon-picker-header">
              <h4>Select Icon</h4>
              <button type="button" className="close-modal-btn" onClick={() => setShowPicker(false)}>✕</button>
            </div>

            <div className="hero-icon-picker-tabs">
              <button
                type="button"
            ...
            <div className="hero-icon-picker-search">
              <input
                type="text"
                placeholder="Search..."
                value={searchTerm}
            ...
            <div className="hero-icon-picker-body">
              <div className="hero-icon-picker-sidebar">
                <h5>Categories</h5>
                {categories.map(cat => (
                  <button
                    key={cat.key}
              ...
              <div className="hero-icon-picker-content">
                {filteredIcons.length > 0 ? (
                  <div className="hero-icon-picker-grid-large">
